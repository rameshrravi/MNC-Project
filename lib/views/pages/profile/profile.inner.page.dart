...
import 'package:midnightcity/widgets/cards/profile.inner.card.dart';
...
class ProfileInnerPage extends StatefulWidget {
  const ProfileInnerPage({Key? key}) : super(key: key);
...
class _ProfileInnerPageState extends State<ProfileInnerPage>
    with AutomaticKeepAliveClientMixin<ProfileInnerPage> {
  @override
