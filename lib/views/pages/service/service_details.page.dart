...
import 'package:midnightcity/view_models/service_details.vm.dart';
import 'package:midnightcity/views/pages/service/widgets/service_details.bottomsheet.dart';
      ...
      builder: (context, vm, child) {
        return BasePage(
          ...
          leading: SizedBox(
            ...
            ).p4().box.roundedSM.color(context.backgroundColor).make().onTap(
              () {
