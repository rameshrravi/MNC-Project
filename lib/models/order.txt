...
import 'package:midnightcity/models/order_attachment.dart';
import 'package:midnightcity/models/order_fee.dart';
import 'package:midnightcity/models/order_service.dart';
import 'package:midnightcity/models/order_status.dart';
import 'package:midnightcity/models/order_stop.dart';
import 'package:midnightcity/models/package_type.dart';
import 'package:midnightcity/models/taxi_order.dart';
...
class Order {
  ...
  factory Order.fromJson(dynamic json) {
    return Order(
      ...
      taxRate: json["tax_rate"] == null ? null : double.parse(json["tax_rate"]),
      tip: json["tip"] == null ? null : double.parse(json["tip"]),
      total: json["total"] == null ? null : double.parse(json["total"]),
      deliveryAddressId: json["delivery_address_id"] == null
          ? null
          : int.parse(json["delivery_address_id"]),
      //
      paymentMethodId: json["payment_method_id"] == null
          ? null
          : int.parse(json["payment_method_id"]),
      vendorId: json["vendor_id"] == null ? null : int.parse(json["vendor_id"]),
      userId: json["user_id"] == null ? null : int.parse(json["user_id"]),
      driverId: json["driver_id"] == null ? null : int.parse(json["driver_id"]),
