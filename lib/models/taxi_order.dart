...
import 'dart:convert';
import 'package:midnightcity/models/currency.dart';
...
class TaxiOrder {
  ...
  LatLng? get pickupLatLng => LatLng(
        double.parse(pickupLatitude!),
        double.parse(pickupLongitude!),
      );
  LatLng? get dropoffLatLng => LatLng(
        double.parse(dropoffLatitude!),
        double.parse(dropoffLongitude!),
      );
}
