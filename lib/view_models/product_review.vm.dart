...
import 'package:midnightcity/models/product_review.dart';
import 'package:midnightcity/models/product_review_stat.dart';
...
import 'package:midnightcity/views/pages/review/product_reviews.page.dart';
...
class ProductReviewViewModel extends MyBaseViewModel {
  ...
  void openAllReviews() {
    ...
    Navigator.push(viewContext!,
        MaterialPageRoute(builder: (context) => ProductReviewsPage(product!)));
  }
